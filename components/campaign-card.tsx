...
export function CampaignCard({ campaign, className = "" }: CampaignCardProps) {
    ...
    return (
        <Link
            ...
            className={`group block bg-card border border-border rounded-xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 active:scale-[0.98] ${className}`}
        >
            {/* Risk Grade Badge */}
