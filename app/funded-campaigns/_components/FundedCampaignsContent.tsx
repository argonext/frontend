...
import { campaignService } from "../../campaigns/_api/campaign-service"
import { formatCurrency } from "../_utils/helpers"
import { ITEMS_PER_PAGE, FUNDED_STATUS } from "../_constants/constants"
import Image from "next/image"

export function FundedCampaignsContent() {
    ...
    const fetchFundedCampaigns = async () => {
        try {
            setLoading(true)
            const allCampaigns = await campaignService.getFundedCampaigns()
